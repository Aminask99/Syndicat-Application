            ...
            <Modal.Body>
                <Form>
                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                        ...
                        <Form.Control className="mb-3" name="Name_Client" onChange={(e)=>
                            setName_Client(e.target.value)}
                            type="text"
                            placeholder="entrer your Name"
                            autoFocus
                            />
                            <Form.Label>Recidance</Form.Label>
                            <Form.Select className="mb-3" name="Recidance" onChange={(e)=> setRecidance(e.target.value)}
                            ...
                            <Form.Select className="mb-3" name="Nb_etage" onChange={(e)=> setEtage(e.target.value)}
                                aria-label="Default select example">
                            ...
                            <Form.Select className="mb-3" name="Ville" onChange={(e)=> setVille(e.target.value)}
                                aria-label="Default select example">
                                <option>Ville</option>
                            ...
                            <Form.Control className="mb-3" type="text" name="prix" value={prix} onChange={(e)=>
                                ...
                                <Form.Control type="text" name="address" value={address} onChange={(e)=>
