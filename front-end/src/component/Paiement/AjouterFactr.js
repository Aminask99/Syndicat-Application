        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Select    className="mb-3"   name="Name_Client"onChange={(e) => setName_Client(e.target.value)}  aria-label="Default select example">
              <option >Name Clinet</option>
  ...
  <option  value={conpan.Name_Client}key={conpan.id}>{conpan.Name_Client}</option>
    ...
    <Form.Label>date payment</Form.Label>
              <Form.Control
                 className="mb-3"
                type="date"
                name="date_payment"  onChange={(e) => setDate_payment(e.target.value)} 
              ...
              <Form.Control
                type="date"
                name="date_facteur"  onChange={(e) => setDatefacteur(e.target.value)}
